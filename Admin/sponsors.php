	 ...
	 <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <h1><?php echo 'sponsors'; ?><small><?php echo $lang['section']; ?></small></h1>

          <ol class="breadcrumb">

            <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> <?php echo $lang['home']; ?></a></li>

            <li class="active"><?php echo 'sponsors'; ?> <?php echo $lang['list']; ?></li>
		 ...
		 <div class="row">	
		 	...
		 	<div class="col-md-12">
                ...
                <div class="box-header">
                  ...
                  <h3 class="box-title"><?php echo 'sponsors'; ?> <?php echo $lang['list']; ?></h3>
                ...
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
				    ...
				    <?php
                     ...
                     $query = DB::getInstance()->get("sponsors", "*", ["ORDER" => "date DESC"]);
                     ...
                     if($query->count()) {
					    ...
					    echo '<td>'. escape(date("d-m-Y", strtotime($row->date))) .'</td>';
