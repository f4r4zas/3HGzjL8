		 ...
		 <div class="row">	
		   ...
		   <?php if(!Input::get('id')): ?>		
                ...
                <div class="box-header">
                  ...
                  <h3 class="box-title">Completed projects <?php echo $lang['list']; ?></h3>
                ...
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
				    ...
				    $qc = DB::getInstance()->get("job", "*", ['completed'=>1]);
					 ...
					 foreach($qc->results() as $rc) {
						...
						if ($qt->count() === 1) {
						 ...
						 foreach($qt->results() as $rt) {
                            ...
                            $job_budget = $rc->budget - 25;
                            
                            $end_date = $rc->end_date;
                            
                            $keehee_paid = $rc->keehee_paid;
					...
					/*	if(escape($type) == 1):
						...
						echo '<td>$'. $job_budget .'</td>';
                        
                        echo '<td>'. $end_date .'</td>';
                        
                        echo '<td>'. $keehee_paid .'</td>';
