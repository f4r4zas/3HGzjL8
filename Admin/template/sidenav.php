      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="header"><?php echo 'sponsors'; ?></li>   
            
            <li class="<?php echo $active = ($basename == 'sponsors') ? ' active' : '';?>">

            	<a href="sponsors.php"><i class='fa fa-list'></i> <span><?php echo 'sponsors'; ?> <?php echo $lang['list']; ?></span></a>
