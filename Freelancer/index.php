 ...
 <body class="skin-green sidebar-mini">
	 ...
	 <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        $query = DB::getInstance()->get("withdraw", "*", ["AND" => ["freelancerid" => $freelancer->data()->freelancerid], "LIMIT" => 1]);
...
<?php }else{ ?>
          <h1><?php echo $lang['dashboard']; ?><small><?php echo $lang['section']; ?></small><a href="withdraw.php?id=2" style="margin-left: 11%; font-size: 17px; font-weight: bold; color:red;">Setup your merchant account now to start receiving payments. <span style="font-size: 20px; color:#0093ff;">Click here!</span></a></h1>
<?php }?>
          ...
          <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              ...
              <div class="info-box">
                ...
                <a href="overview.php?a=profile"><span class="info-box-icon bg-aqua"><img style="width: 100%;" src="<?php echo escape($freelancer->data()->imagelocation); ?>" class="img-circle" alt="User Image" /></span></a>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              ...
              <div class="info-box">
                ...
                <a href="https://keehee.com/jobs.php"><span class="info-box-icon bg-olive"><i class="fa fa-align-left"></i></span></a>

                <div class="info-box-content">

                  <span class="info-box-text">Search for jobs<?php //echo $lang['jobs']; ?> <?php //echo $lang['available']; ?></span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              ...
              <div class="info-box">
                ...
                <a href="proposallist.php"><span class="info-box-icon bg-mint"><i class="fa fa-filter"></i></span></a>

                <div class="info-box-content">

                  <span class="info-box-text">Requested Services</span>

                  <span class="info-box-number">

                    <?php	

                     $query = DB::getInstance()->get("proposal", "*", ["AND" => ["freelancerid" => $freelancer->data()->freelancerid, "active" => 1]]);
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              ...
              <div class="info-box">
                ...
                <a href="membership.php"><span class="info-box-icon bg-olive"><i class="fa fa-users"></i></span></a>
          ...
          <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              ...
              <div class="info-box">
                ...
                <a href="jobassigned.php"><span class="info-box-icon bg-olive"><i class="fa fa-align-right"></i></span></a>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              ...
              <div class="info-box">
                ...
                <a href="paymentsreceived.php"><span class="info-box-icon bg-mint"><i class="fa fa-money"></i></span></a>

                <div class="info-box-content">

                  <span class="info-box-text"><?php echo $lang['outstanding']; ?> <?php echo $lang['payments']; ?> </span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12" style="display: none;">
              ...
              <div class="info-box">
                ...
                <a href="paymentspaid.php"><span class="info-box-icon bg-mint"><i class="fa fa-money"></i></span></a>
