                  ...
                  <table id="example1" class="table table-bordered table-striped">
				    ...
				    <?php
                     ...
                     if($query->count()) {
					    ...
					    echo '<td style="display:none;">'. $currency_symbol .' '. escape($row->budget) .'</td>';
					    ...
					    echo '<td style="display:none;"><span class="label label-success"> ' . $lang['active'] . ' </span> </td>';

						} else {

					    echo '<td style="display:none;"><span class="label label-success"> ' . $lang['in_active'] . ' </span> </td>';
					    ...
					    echo '<td style="display:none;"><span class="label label-success"> ' . $lang['featured'] . ' </span> </td>';

						} else {

					    echo '<td style="display:none;"><span class="label label-success"> ' . $lang['not'] . ' ' . $lang['featured'] . '</span> </td>';

						}																

						

					    echo '<td style="display:none;">'.$pay.'</td>';
