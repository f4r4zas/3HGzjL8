        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <div class="pull-left image">
              ...
              <a href="profile.php?a=image"><img src="<?php echo escape($freelancer->data()->imagelocation); ?>" class="img-circle" alt="User Image" /></a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?php echo $active = ($basename == 'membership') ? ' active' : ''; echo $active = ($editname == 'membership.php?id='. Input::get('id').'') ? ' active' : ''; ?>">
            	...
            	<a href="membership.php"><i class='fa fa-user'></i> <span>Upgrade <?php echo $lang['membership']; ?></span></a>
            ...
            <li class="treeview<?php echo $active = ($basename == 'withdraw') ? ' active' : ''; echo $active = ($editname == 'withdraw.php?id='. Input::get('id').'') ? ' active' : '';  echo $active = ($basename == 'schedule') ? ' active' : ''; ?>">
              ...
              <a href="#"><i class='fa fa-usd'></i> <span>Merchant Account<?php //echo $lang['withdrawals']; ?> <!--&--> <?php //echo $lang['scheduling']; ?></span> <i class="fa fa-angle-left pull-right"></i></a>

              <ul class="treeview-menu">

                <li><a href="withdraw.php">Setup Merchant Account</a></li>
