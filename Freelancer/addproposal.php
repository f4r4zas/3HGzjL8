    ...
    if (!$validation->fails()) {
			...
			try{
			   ...
			   $Insert = DB::getInstance()->insert('proposal', array(
				   ...
				   'description' => 'http://keehee.techopialabs.com/freelancer.php?a=overview&id='.$freelancer->data()->freelancerid.'&requestid='.$proposalid,
 ...
 <body class="skin-green sidebar-mini">
		 ...
		 <!-- Input addon -->
              ...
              <div class="box box-info">
                ...
                <div class="box-body">
                 ...
                 <form role="form" method="post" id="addform" style="display: none;"> 
                  ...
                  <div class="form-group">	
                   ...
                   <div class="input-group">
                    ...
                    <input type="text" name="budget" class="form-control" placeholder="<?php echo $lang['proposal']; ?> <?php echo $lang['budget']; ?>" value="<?php echo escape($job_budget); ?>"/>
    ...
    $(document).ready(function() {
     ...
     $('#summernote').summernote({
        ...
        $('#summernote').summernote('code', "<?php echo 'http://keehee.techopialabs.com/freelancer.php?a=overview&id='.$freelancer->data()->freelancerid;?>");
