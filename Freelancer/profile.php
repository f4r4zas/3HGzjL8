	 ...
	 <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <h1><?php echo 'Account'; ?><small><?php echo $lang['section']; ?></small></h1>

          <ol class="breadcrumb">

            <li><a href="index.php"><i class="fa fa-dashboard"></i> <?php echo $lang['home']; ?></a></li>

            <li class="active"><?php echo 'Account'; ?></li>
		 ...
		 <?php if(isset($imageError)) { //If errors are found ?>
          ...
          <div class="col-lg-4">
	         ...
	         <a href="profile.php?a=profile" class="list-group-item<?php echo $selected; ?>">
	          ...
	          <em class="fa fa-fw fa-user-md text-white"></em>&nbsp;&nbsp;&nbsp;<?php echo 'Account'; ?>

			 </a>

	         <a href="profile.php?a=image" class="list-group-item<?php echo $image; ?>">

	          <em class="fa fa-fw fa-image text-white"></em>&nbsp;&nbsp;&nbsp;<?php if($freelancer_type != 0):?>Business Logo<?php else:?>Your <?php echo $lang['image']; ?><?php endif;?>
	         ...
	         <a style="display: none;" href="profile.php?a=bgimg" class="list-group-item<?php echo $bgimg; ?>">
		 ...
		 <!-- Input addon -->
              ...
              <div class="box box-info">
                ...
                <div class="box-header">
                  ...
                  <h3 class="box-title"><?php echo $lang['edit']; ?> <?php echo 'Account'; ?></h3>
                ...
                <div class="show_data">
				    ...
				    <label><?php if($freelancer_type == 0):?><?php echo $lang['full_name']; ?><?php else:?>Business Name<?php endif;?></label>
                  ...
                  <div class="box-footer">
                    ...
                    <button type="button" class="btn btn-primary full-width edit_button">Edit</button>
                 ...
                 <form role="form" method="post" id="addstudentform" class="show_form" style="display: none;"> 
                  ...
                  <div class="form-group">	
                   ...
                   <div class="input-group">
                    ...
                    <input type="text" name="phone" id="phone" class="form-control" value="<?php echo escape($phone); ?>">
