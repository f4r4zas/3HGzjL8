	 ...
	 <div class="wrapper">
      ...
      <div class="content-wrapper">
            ...
            <div class="col-sm-12 m-b-xs">
			 ...
			 <div class="btn-group pull-right">
              ...
              <a id="<?php echo escape($jobid); ?>" class="btn btn-sm btn-success btn-done"> 
               ...
               <i class="fa fa-check"></i> &nbsp; Redeem voucher<?php //echo $lang['make']; ?> <?php //echo $lang['job']; ?> <?php //echo $lang['done']; ?>			
        ...
        <div style="display: none;" class="col-md-4 text-center">
         ...
         <div style="display: none;" class="col-md-3 text-center">
        ...
        <div class="row">
		 ...
		 <div class="col-lg-8">
		  ...
		  <section style="display: none;" class="panel panel-default">
