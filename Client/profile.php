		 ...
		 <?php if(isset($imageError)) { //If errors are found ?>
          ...
          <div class="col-lg-4">
	         ...
	         <a href="profile.php?a=image" class="list-group-item<?php echo $image; ?>">
	          ...
	          <em class="fa fa-fw fa-image text-white"></em>&nbsp;&nbsp;&nbsp;<?php echo 'Your'; ?> <?php echo $lang['image']; ?>
	         ...
	         <a href="profile.php?a=bgimg" class="list-group-item<?php echo $bgimg; ?>" style="display: none;">
