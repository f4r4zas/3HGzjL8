        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <div class="pull-left image">
              ...
              <a href="profile.php?a=image"><img src="<?php echo escape($client->data()->imagelocation); ?>" class="img-circle" alt="User Image" /></a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview<?php echo $active = ($basename == 'joblist') ? ' active' : ''; echo $active = ($basename == 'addjob') ? ' active' : ''; echo $active = ($editname == 'editjob.php?id='. Input::get('id').'') ? ' active' : ''; ?>">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="addjob.php"><?php echo $lang['post']; ?> <?php echo $lang['a']; ?> <?php echo $lang['service']; ?></a></li>

              </ul>

            </li> 

            <li style="display: none;" class="treeview<?php echo $active = ($basename == 'jobinvite') ? ' active' : ''; echo $active = ($basename == 'addinvite') ? ' active' : ''; echo $active = ($editname == 'editinvite.php?id='. Input::get('id').'') ? ' active' : ''; echo $active = ($editname == 'invite.php?id='. Input::get('id').'') ? ' active' : ''; echo $active = ($editname == 'viewinvite.php?id='. Input::get('id').'') ? ' active' : '';?>">
