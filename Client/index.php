	 ...
	 <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <h1><?php echo $lang['dashboard']; ?> <a href="addjob.php" style="margin-left: 30%; font-weight: bold; color:#e9701c;">POST A SERVICE</a></h1>
          ...
          <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              ...
              <div class="info-box">
                ...
                <a href="joblist.php"><span class="info-box-icon bg-aqua"><i class="fa fa-align-left"></i></span></a>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              ...
              <div class="info-box">
                ...
                <a href="jobassigned.php"><span class="info-box-icon bg-mint"><i class="fa fa-filter"></i></span></a>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              ...
              <div class="info-box">
                ...
                <a href="paymentlist.php"><span class="info-box-icon bg-mint"><i class="fa fa-money"></i></span></a>
